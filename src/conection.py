...
def conectar():
    ...
    df_conjunta.to_sql('datos_conjuntos', con=engine, if_exists='replace', index=False, dtypes={
    ...
    # Subo la tabla a la base de datos
    df_cines.to_sql('info_cines', con=engine, if_exists='replace', index=False, dtypes={
